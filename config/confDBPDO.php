...
define('DSN', 'mysql:host=192.168.20.19;dbname=DB207DWESAplicacionFinalBorja'); // Host 'IP' y nombre de la base de datos
define('USERNAME','user207DWESAplicacionFinal'); // Nombre de usuario de la base de datos
